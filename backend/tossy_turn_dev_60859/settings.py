"""
Django settings for tossy_turn_dev_60859 project.
...
ROOT_URLCONF = 'tossy_turn_dev_60859.urls'
...
WSGI_APPLICATION = 'tossy_turn_dev_60859.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tossy_turn_dev_60859 API",
    "DESCRIPTION": "API documentation for tossy_turn_dev_60859 App",
    "VERSION": "v1",
}
